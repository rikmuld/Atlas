...
(function (Plena) {
    ...
    Plena.init = init;
    function resize() {
        Plena.width = gl.canvas.clientWidth;
        Plena.height = gl.canvas.clientHeight;
        if (gl.canvas.width != Plena.width ||
            gl.canvas.height != Plena.height) {
            gl.canvas.width = Plena.width;
            gl.canvas.height = Plena.height;
        }
    }
